(ns active.clojure.logger.benchmark.clojure-map-record
  "Clojure-map-record-Implementation for metric-store-map."
...
(def who-am-i "clojure-map-record-implementation")
